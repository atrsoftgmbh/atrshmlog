...
int main (int argc, char *argv[])
{
  ...
  PN(atrshmlog_get_inittime().tv_sec);
  PN(atrshmlog_get_inittime().tv_nsec);

  atrshmlog_inittime.tv_sec = strtol(argv[1], NULL, 10);
  atrshmlog_inittime.tv_nsec = strtol(argv[2], NULL, 10);
