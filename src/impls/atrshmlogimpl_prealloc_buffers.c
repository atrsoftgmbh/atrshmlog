...
volatile const void *atrshmlog_get_buffer_cleanup_anchor (void)
{
  ...
  result = (volatile const void *)atomic_load(&atrshmlog_tps);
...
volatile const void *atrshmlog_get_buffer_append_anchor (void)
{
  ...
  result = (volatile const void *)atomic_load(&atrshmlog_tpa);

  return result;
}

/*
 * preset in systems that need it the buffers with memset
 */
