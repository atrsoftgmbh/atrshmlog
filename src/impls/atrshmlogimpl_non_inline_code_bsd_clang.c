...
atrshmlog_time_t atrshmlog_get_clicktime(void)
{
  if (atrshmlog_clock_id == 3)
    {
      return atrshmlog_get_tsc_par_amd64_clang();
    }

  if (atrshmlog_clock_id == 2)
    {
      return atrshmlog_get_tsc_fence_amd64_clang();
    }

  if (atrshmlog_clock_id == 1)
    {
      return atrshmlog_get_tsc_amd64_clang();
    }

  return atrshmlog_get_tsc_null_amd64_clang();
}
# endif
