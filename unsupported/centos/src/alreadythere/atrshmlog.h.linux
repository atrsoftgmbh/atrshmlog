...
#define ATRSHMLOG_SLEEP_NANOS(__n)   atrshmlog_sleep_nanos((__n))
  ...
  /**
   * \brief We switch the statistics gathering on
   *
   * \return
   * Old flag value
   */
#define ATRSHMLOG_SET_STATISTICS_GATHERING_ON() atrshmlog_set_statistics_gathering_on()

  /**
   * \brief We switch the statistics gathering off
   *
   * \return
   * Old flag value
   */
#define ATRSHMLOG_SET_STATISTICS_GATHERING_OFF() atrshmlog_set_statistics_gathering_off()
  
  /**
   * \brief We get  the statistics gathering flag
   *
   * \return
   * Old flag value
   */
#define  ATRSHMLOG_GET_STATISTICS_GATHERING() atrshmlog_get_statistics_gathering()
...
#define ATRSHMLOG_VERIFY() atrshmlog_verify()
   ...
   * Old flag value
   */
  extern atrshmlog_ret_t atrshmlog_set_statistics_gathering_on();
   ...
   * Old flag value
   */
  extern atrshmlog_ret_t atrshmlog_set_statistics_gathering_off();
   ...
   * Old flag value
   */
  extern atrshmlog_ret_t atrshmlog_get_statistics_gathering();
