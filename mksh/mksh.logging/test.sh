...
LC_ALL=C PATH='/usr/lib64/qt-3.3/bin:/usr/lib64/ccache:/usr/local/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/home/shmlog/.local/bin:/home/shmlog/bin:.'; export LC_ALL PATH
test -n "$KSH_VERSION" || exit 1
set -A check_categories --  shell:legacy-no int:32
pflag='/home/shmlog/mksh/mksh.logging/mksh'
sflag='./check.t'
...
print 'test.sh built for mksh R52 2016/01/20 ATRSoft GmbH Log Patched'
