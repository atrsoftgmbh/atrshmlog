...
main_init(int argc, const char *argv[], Source **sp, struct block **lp)
{
 ...
 begin_parse_kshname:
	...
	if (atrshmlog_shmid() != 0)
	  {
	    vp = global( atrshmlog_the_env() );
	    setint_n(vp, atrshmlog_shmid(), 10);

	    typeset(atrshmlog_the_env() , IMPORT | EXPORT, 0, 0, 0);
...
main(int argc, const char *argv[])
{
	...
	ATRSHMLOGGETTIME(0,starttime);

	
	ATRSHMLOGGETTIME(1,endtime);
	...
	ATRSHMLOGGETTIME(1,lastendtime);
	{
	  static const char buffer[] = "hallo welt";
	  
	  ATRSHMLOGWRITE(1, 'I',
		       8000000 + atrshmlog_version(),
		       endtime,
		       lastendtime,
		       buffer,
		       sizeof(buffer) - 1
	...
	/* atr */
	ATRSHMLOGGETTIME(2,endtime);
	{
	  static const char buffer[] = "hallo welt too second last";
	  
	  ATRSHMLOGWRITE(2, 'I',
		       2000000 + atrshmlog_version(),
		       lastendtime,
		       endtime,
		       buffer,
		       sizeof(buffer) - 1
	...
	/* atr */
	ATRSHMLOGGETTIME(2,lastendtime);
	ATRSHMLOGGETTIME(2,endtime);
	ATRSHMLOGGETTIME(2,endtime);
	ATRSHMLOGGETTIME(2,endtime);
	ATRSHMLOGGETTIME(2,endtime);
	...
	int linehint)
{
	...
	ATRSHMLOGGETTIME(20,starttime);

	shf = shf_open(name, O_RDONLY, 0, SHF_MAPHI | SHF_CLEXEC);
	if (shf == NULL) {

	  ATRSHMLOGGETTIME(21,endtime);
