...
substitute(const char *cp, int f, int linehint)
{
	...
	ATRSHMLOGGETTIME(100,starttime);
	
	{
	  if(cp)
	    {
	      int len = strlen(cp);
	  ATRSHMLOGWRITE(101, 'P',
		      linehint,
		      starttime,
		      starttime,
		      cp,
	...
	ATRSHMLOGGETTIME(102,endtime);
	{

	  if(res)
	    {
	      int len = strlen(res);
	  ATRSHMLOGWRITE(102, 'I',
		      linehint,
		      starttime,
		      endtime,
		      res,
...
evalstr(const char *cp, int f, int linehint)
{
	...
	ATRSHMLOGGETTIME(120,starttime);
	...
	ATRSHMLOGGETTIME(121,endtime);
	if (dp)
	  {
	    int len = strlen(dp);
	    ATRSHMLOGWRITE(123, 'I',
			linehint, 
			starttime,
			endtime,
			dp,
       ...
       int linehint)
{
	...
	ATRSHMLOGGETTIME(130,starttime);
 ...
 emit_word:
	...
	ATRSHMLOGGETTIME(131,endtime);
	{
	  if(ccp)
	    {
	      int len = strlen(ccp);
	  ATRSHMLOGWRITE(131, 'I',
		      0,
		      starttime,
		      endtime,
		      ccp,
