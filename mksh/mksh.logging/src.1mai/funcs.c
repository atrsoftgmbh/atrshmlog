...
c_dot(const char **wp)
{
	...
	ATRSHMLOGGETTIME(500,starttime);
	...
	ATRSHMLOGGETTIME(501,endtime);
	{
	  if(file)
	    {
	      int len =       strlen(file);

	      ATRSHMLOGWRITE(501, 'I',
			      g_linehint,
			      starttime,
			      endtime,
			      file,
...
c_wait(const char **wp)
{
	...
	ATRSHMLOGGETTIME(503,starttime);
	...
	ATRSHMLOGGETTIME(504,endtime);
	{
		  ATRSHMLOGWRITE(504, 'I',
			      g_linehint,
			      starttime,
			      endtime,
			      "wait for childs",
