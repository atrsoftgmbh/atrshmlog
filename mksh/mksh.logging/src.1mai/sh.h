...
#endif
#define MKSH_VERSION "R52 2016/01/20 ATRSoft GmbH Log Patched"
...
/* eval.c */
char *substitute(const char *, int, int linehint);
char **eval(const char **, int, int linehint);
char *evalstr(const char *cp, int, int linehint);
char *evalonestr(const char *cp, int, int linehint);
char *debunk(char *, const char *, size_t);
void expand(const char *, XPtrV *, int, int linehint);
...
/* expr.c */
int evaluate(const char *, mksh_ari_t *, int, bool, int linehint);
int v_evaluate(struct tbl *, const char *, volatile int, bool, int linehint);
/* UTF-8 stuff */
...
/* main.c */
int include(const char *, int, const char **, bool, int linehint);
...
int test_parse(Test_env *, int linehint);
